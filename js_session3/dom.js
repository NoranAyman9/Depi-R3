// dom (document object based)
// bom (browser object based)
// javaScript Object Model (DOM) is a programming interface for web documents.
// It represents the structure of a document as a tree of objects, allowing scripts to access and
// manipulate the content, structure, and style of a document.
// The DOM represents the document as a tree of nodes, where each node is an object representing
// a part of the document, such as an element, attribute, or text.
// The DOM is a language-neutral interface, meaning it can be accessed and manipulated using various programming
// children .. childnodes
...
// let names = ["noran","ayman","ali"]
// // loops on element
// names.forEach((el)=>{
//     list.innerHTML+= `<h1>${el}</h1>`
// })
